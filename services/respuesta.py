...
# Ruta para actualizar múltiples respuestas
...
def insert():
    ...
    respuesta_usuario = body.get('respuesta_usuario')
    ...
    if not respuesta_usuario or not pregunta_id or not id_estudiante:
        ...
        result["msg"] = "Faltan datos requeridos"
    ...
    result["status_code"]=201
    result["msg"]="Se agrego la respuesta"
    return jsonify(result),201
